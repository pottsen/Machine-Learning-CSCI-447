    ...
    def confusion_matrix(self):
        ...
        for class_name in unique_class:
            for i in range(len(self.results)):
                ...
                elif class_name == self.results[i][1] and class_name != results[i][0]: #guessed that a record was part of a class and it wasn't
                ...
                elif class_name != results[i][1] and class_name != results[i][0]: #guess is accurate that the record did not belong to a class
